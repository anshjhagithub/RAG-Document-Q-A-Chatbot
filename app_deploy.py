...
try:
    ...
    st.error(f"LangChain modules not available: {e}")
...
if not LANGCHAIN_AVAILABLE:
    st.error("⚠️ Required dependencies are not installed. Please install the required packages.")
    st.code("""
        ...
        with st.spinner('🔄 Processing your documents...'):
            ...
            if documents:
                ...
                try:
                    ...
                    st.info("This might be due to missing dependencies. Please check the requirements.")
                    st.stop()
